...
namespace CSharpCourseLecture101 {
    ...
    public partial class SampleDataSet2 : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow AddTableRow(int Id, int Output) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public int Output {
                get {
                    try {
                        return ((int)(this[this.tableTable.OutputColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Output\' in table \'Table\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableTable.OutputColumn] = value;
                }
            }
            ...
            public bool IsOutputNull() {
                return this.IsNull(this.tableTable.OutputColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetOutputNull() {
                this[this.tableTable.OutputColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace CSharpCourseLecture101.SampleDataSet2TableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ((@IsNull_Output = 1 A" +
                "ND [Output] IS NULL) OR ([Output] = @Original_Output)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [Output]) VALUES (@Id, @Output);\r\nSELECT Id, Out" +
                "put FROM [Table] WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Table] SET [Id] = @Id, [Output] = @Output WHERE (([Id] = @Original_" +
                "Id) AND ((@IsNull_Output = 1 AND [Output] IS NULL) OR ([Output] = @Original_Outp" +
                "ut)));\r\nSELECT Id, Output FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CSharpCourseLecture101.Properties.Settings.Default.SampleConnectionString1;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Output FROM dbo.[Table]";
        ...
        public virtual int Fill(SampleDataSet2.TableDataTable dataTable) {
        ...
        public virtual SampleDataSet2.TableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            SampleDataSet2.TableDataTable dataTable = new SampleDataSet2.TableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(SampleDataSet2.TableDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, global::System.Nullable<int> Original_Output) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_Id));
            if ((Original_Output.HasValue == true)) {
                this.Adapter.DeleteCommand.Parameters[1].Value = ((object)(0));
                this.Adapter.DeleteCommand.Parameters[2].Value = ((int)(Original_Output.Value));
            }
            else {
        ...
        public virtual int Insert(int Id, global::System.Nullable<int> Output) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(Id));
            if ((Output.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[1].Value = ((int)(Output.Value));
            }
            else {
        ...
        public virtual int Update(int Id, global::System.Nullable<int> Output, int Original_Id, global::System.Nullable<int> Original_Output) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(Id));
            if ((Output.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(Output.Value));
            }
            else {
            ...
            if ((Original_Output.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(Original_Output.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<int> Output, int Original_Id, global::System.Nullable<int> Original_Output) {
            return this.Update(Original_Id, Output, Original_Id, Original_Output);
        }
    }
