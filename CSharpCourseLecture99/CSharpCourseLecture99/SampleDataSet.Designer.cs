...
namespace CSharpCourseLecture99.SampleDataSetTableAdapters {
    ...
    public partial class PeopleTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[People] SET [Id] = @Id, [FirstName] = @FirstName, [LastName] = @LastName WHERE (([Id] = @Original_Id) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName));
SELECT Id, FirstName, LastName FROM People WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CSharpCourseLecture99.Properties.Settings.Default.SampleConnectionString;
        }
        ...
        public virtual int Fill(SampleDataSet.PeopleDataTable dataTable) {
        ...
        public virtual SampleDataSet.PeopleDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            SampleDataSet.PeopleDataTable dataTable = new SampleDataSet.PeopleDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(SampleDataSet.PeopleDataTable dataTable) {
