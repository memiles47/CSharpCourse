...
class Program
{
    static void Main()
    {
        string connectionString = @"Data Source = MEM_SURFACE\SQLEXPRESS; Initial Catalog = Sample; Integrated Security = True; Connect Timeout = 15; Encrypt = False; TrustServerCertificate = False; ApplicationIntent = ReadWrite; MultiSubnetFailover = False";
